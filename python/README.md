...
- **<a href="https://github.com/eddes/INSA/blob/main/python/tuto_equa_diff.ipynb">Tuto \#6<a>** : intégrer une équation différentielle/un système d'équations différentielles
